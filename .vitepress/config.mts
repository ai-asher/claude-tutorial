...
export default withMermaid(defineConfig({
  ...
  locales: {
    zh: {
      ...
      themeConfig: {
          ...
          '/zh/guide/': [
            {
              ...
              items: [
                ...
                { text: 'Effort 等级与模型选择', link: '/zh/guide/effort-levels' },
              ]
            }
          ],
          '/zh/commands/': [
          ...
          '/zh/features/': [
            {
              ...
              items: [
                ...
                { text: '动态工作流', link: '/zh/features/workflows' },
                { text: 'Agent View', link: '/zh/features/agent-view' },
                { text: '目标模式 /goal', link: '/zh/features/goal-mode' },
        ...
        editLink: {
          pattern: 'https://github.com/ai-asher/claude-tutorial/edit/main/:path',
          text: '在 GitHub 上编辑此页'
        },
      }
    },
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/ai-asher/claude-tutorial' },
    ],
    footer: {
